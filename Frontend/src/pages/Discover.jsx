...
useEffect(() => {
  ...
  <DropdownMenuContent className="bg-white text-black">
    {isLoggedIn ? (
      ...
      <>
        <DropdownMenuItem onClick={() => navigate("/login", { state: { tab: "login", from: location },  })}>Login</DropdownMenuItem>
        <DropdownMenuItem onClick={() => navigate("/login", { state: { tab: "register" , from: location} })}>Register</DropdownMenuItem>
      </>
    )}
  </DropdownMenuContent>
</DropdownMenu>
