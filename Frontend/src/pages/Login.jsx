...
const handleResendOTP = () => {
        ...
        <div className="w-full md:w-1/2 bg-black p-8 text-white">
          <Tabs defaultValue={defaultTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 bg-yellow-500 text-black rounded-lg">
              <TabsTrigger value="login" className="data-[state=active]:bg-black data-[state=active]:text-yellow-400">
                Login
              </TabsTrigger>
              <TabsTrigger value="register" className="data-[state=active]:bg-black data-[state=active]:text-yellow-400">
                Register
              </TabsTrigger>
            </TabsList>
  ...
  >
    ...
    {otpMessage && (
      <p className="text-yellow-400 text-sm text-center">{otpMessage}</p>
    )}
    {registerError && (
